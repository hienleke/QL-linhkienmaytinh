 ...
 * @author Ke Hien Le
 */
public class formxacnhan extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
         LinhkienDAO sadfa = new LinhkienDAO(Linhkien.class);
         
               boolean k = sadfa.delete(new Linhkien(id));
               if(k==true)
               {
                  xacnhan=1;
               }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formxacnhan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formxacnhan().setVisible(true);
            }
        });
    }
