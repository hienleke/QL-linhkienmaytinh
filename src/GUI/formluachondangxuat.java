 ...
 * @author Ke Hien Le
 */
public class formluachondangxuat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel30.setText("Bạn có  muốn đăng xuất không ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formluachondangxuat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formluachondangxuat().setVisible(true);
            }
        });
    }
