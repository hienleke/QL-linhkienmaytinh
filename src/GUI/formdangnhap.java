...
public class formdangnhap extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        Nhanvien x  = nvdao.findById(jTextField1.getText().toUpperCase().trim());
        if (x==null)
        {
            jLabel2.setText("Không tồn tại tài khoản");
            return;
        }
        else if(!x.getTaikhoan().equalsIgnoreCase(jPasswordField1.getText()))
         {
            ...
            return;
                 ...
                 {
                 Frame giaodien = new Frame();
                 giaodien.setVisible(true);
                 giaodien.setNhanvien(x);
                 giaodien.nhapthongtinnhanvien();
