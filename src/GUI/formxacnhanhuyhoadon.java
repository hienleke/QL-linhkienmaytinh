 ...
 * @author Ke Hien Le
 */
public class formxacnhanhuyhoadon extends javax.swing.JFrame {
     ...
     */
    public formxacnhanhuyhoadon(Frame frame) {
        initComponents();
        this.frame=frame;
    ...
    private void initComponents() {
        ...
        jLabel30.setText("Bạn có  muốn hủy giao dịch này ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formxacnhanhuyhoadon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               // new formxacnhanhuyhoadon().setVisible(true);
            }
        });
    }
