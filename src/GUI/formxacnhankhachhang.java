 ...
 * @author Ke Hien Le
 */
public class formxacnhankhachhang extends javax.swing.JFrame {
   ...
   private Nhacungcap  ncc ;
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
          ...
          // System.out.println(id);
               KhanhhangDAO ndao = new KhanhhangDAO(Khachhang.class);
       
        
           boolean kq = ndao.delete(new Khachhang(id));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formxacnhankhachhang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formxacnhankhachhang().setVisible(true);
            }
        });
    }
