 ...
 * @author Ke Hien Le
 */
public class formxacnhannhanvien extends javax.swing.JFrame {
   ...
   private Nhacungcap  ncc ;
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
          ...
          // System.out.println(id);
               NhanvienDAO ndao = new NhanvienDAO(Nhanvien.class);
       
        
           boolean kq = ndao.delete(new Nhanvien(id));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formxacnhannhanvien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formxacnhannhanvien().setVisible(true);
            }
        });
    }
