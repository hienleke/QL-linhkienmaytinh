 ...
 * @author Ke Hien Le
 */
public class formxacnhan_xoaxuatxu extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        boolean kq = dao.delete(new Xuatxu(id));



                this.dispose();
                        if (kq == false) {
            JOptionPane.showMessageDialog(this, "Xoá xuất xứ thất bại !!!");
        }else{
            JOptionPane.showMessageDialog(this, "Xoá xuất xứ thành công !!!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formxacnhan_xoaxuatxu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formxacnhan_xoaxuatxu().setVisible(true);
            }
        });
    }
